// lib/screens/saved_paidleave_cuti_screen.dart
...
import 'create_paidleave_cuti_form.dart'; // Ensure this import exists
import '../widgets/custom_bottom_app_bar.dart';

class SavedPaidLeaveCutiScreen extends StatefulWidget {
  final List<Map<String, dynamic>> paidLeaves;

  const SavedPaidLeaveCutiScreen({
    Key? key,
    required this.paidLeaves,
  }) : super(key: key);

  @override
  _SavedPaidLeaveCutiScreenState createState() =>
      _SavedPaidLeaveCutiScreenState();
}

class _SavedPaidLeaveCutiScreenState extends State<SavedPaidLeaveCutiScreen> {
  // Sorting
  ...
  /// Helper method to parse date from ISO8601 string to DateTime
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Saved Paid Leave/Cuti Screen"),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) =>
                        CreatePaidLeaveCutiForm(paidLeaves: widget.paidLeaves),
                  ),
                ).then((_) {
                  setState(() {});
                });
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) => PaidLeaveCutiDetailScreen(
                paidLeave: leaveData,
                allPaidLeaves: widget.paidLeaves,
              ),
            ),
          ).then((_) {
            setState(() {});
  ...
  /// Helper method to format date from ISO8601 string to "dd-MM-yyyy"
